...
public class CalenderProgram {
	    ...
	    {   Utility u=new Utility();
	        CalenderProgram ob = new CalenderProgram();
	        ...
	        int max = ((CalenderProgram) ob).findMaxDay(mname,y);
	        int f = ((CalenderProgram) ob).findDayNo(wname);        
	        ((CalenderProgram) ob).fillCalendar(max,f,mname,y);
	    }
	}
