		...
		switch (choice) 
		{
			...
			case 5:
					...
					if(doc!=null)
					{
						if(doc.size()>=1)
						{
							System.out.println("Enter Date of Appointment(eg.04/06/2018): ");
							Date date=u.printDate(u.getString());
							if(date==null)
							{
